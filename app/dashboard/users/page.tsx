                    ...
                    <table className="w-full text-left">
                        <thead>
                            <tr className="bg-gray-50/50">
                                <th className="px-4 sm:px-6 py-4 text-[10px] uppercase font-black text-gray-400 tracking-widest">
                                    User Profile
                                </th>
                                <th className="px-4 sm:px-6 py-4 text-[10px] uppercase font-black text-gray-400 tracking-widest">
                                    Digital ID
                                </th>
                                <th className="px-4 sm:px-6 py-4 text-[10px] uppercase font-black text-gray-400 tracking-widest text-right whitespace-nowrap">
                                    Actions
                                </th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-50">
                            {users.map((user) => (
                                ...
                                >
                                    <td className="px-4 sm:px-6 py-4">
                                        <div className="flex items-center gap-3 sm:gap-4">
                                            ...
                                            <div className="min-w-0">
                                                <p className="font-black text-foreground group-hover:text-primary transition-colors tracking-tight text-sm sm:text-base truncate">
                                                    {user.name}
                                                </p>
                                                <div
                                                    className={`mt-1 inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md text-[8px] sm:text-[9px] font-black uppercase tracking-widest ${
                                                        user.role ===
                                                        "super-admin"
                                    ...
                                    <td className="px-4 sm:px-6 py-4">
                                        <div className="space-y-1">
                                            <div className="flex items-center gap-1.5 text-[10px] sm:text-xs font-bold text-gray-600 truncate max-w-37.5 sm:max-w-none">
                                                <Mail
                                                    size={12}
